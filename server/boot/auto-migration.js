  ...
  function createWorkEvents(memebers, cb) {
    mysqlDs.automigrate('WorkEvent', function(err) {
      ...
      WorkEvent.create([
        ...
        {
          title: 'engagement for jackson',
          type: 'engagement',
          description: 'a quick engagement in summer',
          start: (new Date(2018, 4, 2, 10, 10, 0, 0)).toJSON(),
          end: (new Date(2018, 4, 2, 20, 10, 0, 0)).toJSON(),
          createdOn: (new Date()).toJSON(),
          modifiedOn: (new Date()).toJSON(),
          ownerId: memebers[0].id,
        },
        {
          title: 'wedding for johnny',
          type: 'wedding',
          description: 'todays wedding',
          start: (new Date(2017, 10, 8, 10, 10, 0, 0)).toJSON(),
          end: (new Date(2017, 10, 8, 20, 10, 0, 0)).toJSON(),
          createdOn: (new Date()).toJSON(),
          modifiedOn: (new Date()).toJSON(),
          ownerId: memebers[0].id,
        },
        {
          title: 'wedding for kaka',
          type: 'wedding',
          description: 'yesterdays wedding',
          start: (new Date(2017, 10, 7, 10, 10, 0, 0)).toJSON(),
          end: (new Date(2017, 10, 7, 20, 10, 0, 0)).toJSON(),
          createdOn: (new Date()).toJSON(),
          modifiedOn: (new Date()).toJSON(),
          ownerId: memebers[0].id,
        },
        {
          title: 'wedding for kona',
          type: 'wedding',
          description: 'tomorrows wedding',
          start: (new Date(2017, 10, 9, 10, 10, 0, 0)).toJSON(),
          end: (new Date(2017, 10, 9, 20, 10, 0, 0)).toJSON(),
          createdOn: (new Date()).toJSON(),
          modifiedOn: (new Date()).toJSON(),
          ownerId: memebers[0].id,
        },
